...
web build:
 - http://mootools.net/core/8bd4fbe22ed2c18ae417f99f598ff876

packager build:
 - packager build Core/Core Core/Function Core/Event Core/Class Core/Element.Event Core/Request Core/Request.JSON
...
}};}})();(function(){this.Chain=new Class({$chain:[],chain:function(){this.$chain.append(Array.flatten(arguments));return this;},callChain:function(){return(this.$chain.length)?this.$chain.shift().apply(this,arguments):false;
